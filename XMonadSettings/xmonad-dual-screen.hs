...
myWorkspaces = withScreens 2 ["WS1","WS2","WS3","WS4", "WS5", "WS6", "WS7", "WS8", "WS9"]
...
myManageHook = (composeAll.concat $
                [[isFullscreen --> doFullFloat
                 , className =? "Skype" --> doShift "0_WS5"
                 , className =? "Pidgin" --> doShift "0_WS5"
                 , className =? "Gimp" --> doShift "0_WS6"
                 , className =? "VirtualBox" --> doShift "0_WS7"
                 , className =? "Stardict" --> doFloat <+> doShift "0_WS9"
                 , className =? "Wine" --> doShift "0_WS8"
                 ]]
...
-----------------------------------------------------------------------------------
-- Layout
myLayoutHook = onWorkspace "0_WS5" imLayout $ onWorkspace "0_WS6" gimpLayout $ onWorkspace "0_WS7" vmLayout $ standardLayouts
    where
